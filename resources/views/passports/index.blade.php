...
@section('content')
    ...
    <div x-data="{ 
        ...
        <!-- Modal Box -->
        <div class="bg-white rounded-lg shadow-xl p-6 m-4" style="width: 320px; max-width: 90%;"
            @click.away="open = false">
            
            <!-- Header -->
            <div class="text-center mb-4">
                <div class="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-green-100 mb-3">
                    <svg class="h-5 w-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                    </svg>
                </div>
                <h3 class="text-base font-semibold text-gray-900">تغيير حالة الجواز</h3>
                <p class="mt-1 text-sm text-gray-500" x-text="passportName"></p>
            </div>

            <!-- Dropdown -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1 text-right">الحالة الجديدة</label>
                <select x-model="currentStatus" 
                    class="block w-full rounded-md border border-gray-300 py-2 px-3 text-gray-900 text-sm focus:ring-2 focus:ring-china-red focus:border-china-red">
            ...
            <div class="flex gap-2">
                <button type="button" 
                    ...
                    "
                    :disabled="loading"
                    class="flex-1 rounded-md bg-china-red px-3 py-2 text-sm font-semibold text-white hover:bg-china-dark disabled:opacity-50">
                    <span x-show="!loading">حفظ</span>
                    <span x-show="loading">جاري...</span>
                </button>
                <button type="button" @click="open = false"
                    class="flex-1 rounded-md bg-gray-100 px-3 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-200">إلغاء</button>
            </div>
        </div>
    </div>
@endsection